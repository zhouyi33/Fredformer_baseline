...
if __name__ == '__main__':
    ...
    # 新增参数
    parser.add_argument('--cf_dim', type=int, default=32)  # feature dimension
    ...
    parser.add_argument('--cf_mlp', type=int, default=32)  # ff dimension
    ...
    parser.add_argument('--fc_dropout', type=float, default=0.02, help='fully connected dropout')
